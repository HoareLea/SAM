...
namespace SAM.Analytical.Rhino.Plugin
{
    ...
    {
        public static void SetBucketSizes(this List<Panel> panels, double offset = 0.1, double tolerance_Angle = Core.Tolerance.Angle, double tolerance_Distance = Core.Tolerance.Distance)
        {
            if (panels == null)
            {
                return;
