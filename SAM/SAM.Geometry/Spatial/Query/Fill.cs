...
namespace SAM.Geometry.Spatial
{
    ...
    {
        public static List<Face3D> Fill(this Face3D face3D, IEnumerable<Face3D> face3Ds, double tolerance = SAM.Core.Tolerance.Distance)
        {
            ...
            return Planar.Query.Fill(face2D, face2Ds, tolerance)?.ConvertAll(x => plane.Convert(x));
        }
    }
}