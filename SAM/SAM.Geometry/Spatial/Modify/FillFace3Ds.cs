...
namespace SAM.Geometry.Spatial
{
    ...
    {
        public static bool FillFace3Ds(this List<Shell> shells, IEnumerable<Face3D> face3Ds, double offset = 0.1, double maxDistance = 0.1, double maxAngle = 0.0872664626, double tolerance = Core.Tolerance.Distance)
        {
            ...
            for(int i=0; i < shells.Count; i++)
            {
                ...
                if (shell != null)
                {
                    ...
                    bool updated = shell_New.FillFace3Ds(face3Ds, offset, maxDistance, maxAngle, tolerance);
                    if (updated)
                    {
