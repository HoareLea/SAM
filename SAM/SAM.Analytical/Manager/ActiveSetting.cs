...
namespace SAM.Analytical
{
    public static partial class ActiveSetting
    {
        ...
        public static Setting GetDefault()
        {
            ...
            construction.SetPanelType(PanelType.Ceiling);
            result.Add(Name.Construction_Ceiling, construction);

            construction = new Construction(new System.Guid("9ab5d49f-4db4-4930-8293-3945d430e572"), "SIM_EXT_GLZ", Create.ConstructionLayers("_Glazing Inner Pane_g0.78_Lt0.89", 0.006, "Ar0UP_Air__12mm_3.168W/m2K", 0.12, "_Side Lit Glazing Outer Pane_g0.41_Lt0.9", 0.006));
            construction.SetPanelType(PanelType.CurtainWall);
            ...
            construction.SetPanelType(PanelType.Floor);
            ...
            construction.SetPanelType(PanelType.FloorExposed);
            ...
            construction.SetPanelType(PanelType.FloorInternal);
            ...
            construction.SetPanelType(PanelType.FloorRaised);
            ...
            construction.SetPanelType(PanelType.Roof);
            ...
            construction.SetPanelType(PanelType.Shade);
            ...
            construction.SetPanelType(PanelType.SlabOnGrade);
            ...
            construction.SetPanelType(PanelType.SolarPanel);
            ...
            construction.SetPanelType(PanelType.Undefined);
            ...
            construction.SetPanelType(PanelType.UndergroundCeiling);
            ...
            construction.SetPanelType(PanelType.UndergroundSlab);
            ...
            construction.SetPanelType(PanelType.WallInternal);
