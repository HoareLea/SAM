...
namespace SAM.Analytical
{
    ...
    {
        public static List<T> Filter<T>(this AnalyticalModel analyticalModel, IFilter filter, IEnumerable<IJSAMObject> jSAMObjects = null) where T : IJSAMObject
        {
            if (analyticalModel == null || filter == null)
            {
                return null;
            }
