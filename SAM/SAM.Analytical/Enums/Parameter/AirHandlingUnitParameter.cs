...
namespace SAM.Analytical
{
    ...
    public enum AirHandlingUnitParameter
    {
        ...
        [ParameterProperties("Heat Recovery Sensible Efficiency", "Heat Recovery Sensible Efficiency [0-1]"), DoubleParameterValue(0, 1)] HeatRecoverySensibleEfficiency,
        [ParameterProperties("Heat Recovery Latent Efficiency", "Heat Recovery Latent Efficiency [0-1]"), DoubleParameterValue(0, 1)] HeatRecoveryLatentEfficiency,
        ...
        [ParameterProperties("Cooling Coil Off Temperature Temperature", "Cooling Coil Off Temperature [°C]"), ParameterValue(Core.ParameterType.Double)] CoolingCoilOffTemperature,
