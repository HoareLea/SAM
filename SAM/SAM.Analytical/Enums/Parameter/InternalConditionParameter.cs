...
namespace SAM.Analytical
{
    ...
    public enum InternalConditionParameter
    {
        ...
        [ParameterProperties("Occupant Sensible Gain", "Occupant Sensible Gain [W]"), ParameterValue(Core.ParameterType.Double)] OccupantSensibleGain,
        [ParameterProperties("Occupant Latent Gain", "Occupant Latent Gain [W]"), ParameterValue(Core.ParameterType.Double)] OccupantLatentGain,
        [ParameterProperties("Occupant Sensible Gain Per Area", "Occupant Sensible Gain Per Area [W/m2]"), ParameterValue(Core.ParameterType.Double)] OccupantSensibleGainPerArea,
        [ParameterProperties("Occupant Latent Gain Per Area", "Occupant Latent Gain Per Area [W/m2]"), ParameterValue(Core.ParameterType.Double)] OccupantLatentGainPerArea,
        ...
        [ParameterProperties("Design Lux Level", "Design Lux Level [lux]"), DoubleParameterValue(0)] DesignLuxLevel,
        ...
        [ParameterProperties("Light Efficiency", "Light Efficiency [W/m²/100lux]"), ParameterValue(Core.ParameterType.Double)] LightEfficiency,
        [ParameterProperties("Natural Ventilation Outdoor Air Per Person", "Natural Ventilation Outdoor Air Per Person [l/s/p]"), ParameterValue(Core.ParameterType.Double)] NaturalVentilationOutdoorAirPerPerson,
        [ParameterProperties("Natural Ventilation Outdoor Air Changes Per Hour", "Natural Ventilation Outdoor Air Changes Per Hour [ACH]"), ParameterValue(Core.ParameterType.Double)] NaturalVentilationOutdoorAirChangesPerHour,
