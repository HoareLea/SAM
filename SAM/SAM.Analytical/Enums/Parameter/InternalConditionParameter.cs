...
namespace SAM.Analytical
{
    ...
    public enum InternalConditionParameter
    {
        ...
        [ParameterProperties("Occupancy Sensible Gain Per Area", "Occupancy Sensible Gain Per Area [W/m2]"), ParameterValue(Core.ParameterType.Double)] OccupancySensibleGainPerArea,
        [ParameterProperties("Occupancy Latent Gain Per Area", "Occupancy Latent Gain Per Area [W/m2]"), ParameterValue(Core.ParameterType.Double)] OccupancyLatentGainPerArea,
