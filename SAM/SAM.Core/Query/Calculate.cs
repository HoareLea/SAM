...
namespace SAM.Core
{
    public static partial class Query
    {
        ...
        private static double Calculate_WIP(this Func<double, double> func, double value, double start, double stop, out int count, out double calculationValue, int maxCount = 100, double tolerance = Core.Tolerance.MacroDistance)
        {
            calculationValue = double.NaN;
            count = -1;
