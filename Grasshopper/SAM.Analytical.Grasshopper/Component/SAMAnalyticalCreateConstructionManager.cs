    ...
    public class SAMAnalyticalCreateConstructionManager : GH_SAMVariableOutputParameterComponent
    {
        ...
        public SAMAnalyticalCreateConstructionManager()
          : base("SAMAnalytical.CreateConstructionManager", "SAMAnalytical.CreateConstructionManager",
              "Create CreateConstructionManager",
              "SAM", "Analytical")
        {
        }
        ...
        protected override GH_SAMParam[] Inputs
        {
            get
            {
                ...
                GooAnalyticalObjectParam analyticalObjectParam = new GooAnalyticalObjectParam() { Name = "_constructions", NickName = "_constructions", Description = "SAM Analytical Constructions", Access = GH_ParamAccess.list };
