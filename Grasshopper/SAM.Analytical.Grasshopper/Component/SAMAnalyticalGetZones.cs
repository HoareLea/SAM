...
{
    public class SAMAnalyticalGetZones : GH_SAMVariableOutputParameterComponent
    {
        /// <summary>
        ...
        /// </summary>
        public SAMAnalyticalGetZones()
          : base("SAMAnalytical.GetZones", "SAMAnalytical.GetZones",
        ...
        protected override void SolveInstance(IGH_DataAccess dataAccess)
        {
            ...
            List<GuidCollection> groups = null;
            ...
            groups = adjacencyCluster?.GetGroups(space);

            index = Params.IndexOfOutputParam("Zones");
            if (index != -1)
                dataAccess.SetDataList(index, groups);

            index = Params.IndexOfOutputParam("Spaces");
            if (index != -1 && groups != null && adjacencyCluster != null)
            {
                ...
                foreach (GuidCollection group in groups)
                {
                    ...
                    List<Space> spaces = adjacencyCluster.GetObjects<Space>(group);
