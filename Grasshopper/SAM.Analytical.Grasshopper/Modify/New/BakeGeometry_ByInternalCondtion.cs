...
namespace SAM.Analytical.Grasshopper
{
    ...
    {
        public static void BakeGeometry_ByInternalCondition_Rooms(this RhinoDoc rhinoDoc, global::Grasshopper.Kernel.Data.IGH_Structure gH_Structure, bool cutApertures = false, double tolerance = Core.Tolerance.Distance)
        {
            ...
            if (rooms != null && rooms.Count != 0)
                BakeGeometry_ByInternalCondition(rhinoDoc, rooms);
        }

        public static void BakeGeometry_ByInternalCondition(this RhinoDoc rhinoDoc, IEnumerable<Room> rooms)
        {
            Rhino.DocObjects.Tables.LayerTable layerTable = rhinoDoc?.Layers;
            if (layerTable == null)
                return;
            ...
            foreach (Room room in rooms)
            {
                ...
                string internalConditionName = room.Name;//room.InternalCondition?.Name;
                ...
                Layer layer_Level = Core.Grasshopper.Modify.GetLayer(layerTable, layer_Rooms.Id, internalConditionName, color);
