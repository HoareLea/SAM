...
namespace SAM.Analytical.Grasshopper
{
    ...
    {
        public static void BakeGeometry_ByApertureType(this RhinoDoc rhinoDoc, global::Grasshopper.Kernel.Data.IGH_Structure gH_Structure)
        {
            if (rhinoDoc == null)
                return;
            ...
            Rhino.Modify.BakeGeometry_ByApertureType(rhinoDoc, apertures);
        }
  }
}