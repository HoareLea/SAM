...
{
    public class GH_SAMComponentAttributes : GH_ComponentAttributes
    {
        public GH_SAMComponentAttributes(GH_Component component) : base(component)
        {
        }
        ...
        protected override void Render(GH_Canvas canvas, Graphics graphics, GH_CanvasChannel channel)
        {
            ...
            if (channel == GH_CanvasChannel.Objects)
            {
                ...
                //var name = mode == 1 ? this.Owner.NickName : this.Owner.Name.Replace("SAM_", "");
